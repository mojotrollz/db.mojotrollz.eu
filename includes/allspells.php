...
function render_spell_tooltip(&$row) {
    ...
    $x .= '<b>' . $row['spellname'] . '</b><br />';

    if ($row['rank'])
        $x .= '</td><th><b class="q0">' . $row['rank'] . '</b></th></tr></table>';
